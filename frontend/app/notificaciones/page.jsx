    ...
    <div className="p-4">
      ...
      <p className="text-gray-600">No hay notificaciones.</p>
        ...
        <>
          {unread.length > 0 && (
            <div className="mb-6">
              <h2 className="font-semibold mb-2">No leídas</h2>
              <ul className="space-y-4">
                {unread.map(n => (
                  <li
                    key={n.id}
                    className="bg-blue-50 shadow border-l-4 border-blue-400 rounded p-4 flex justify-between items-start"
                  >
          ...
          {read.length > 0 && (
            <div>
              <h2 className="font-semibold mb-2">Leídas</h2>
              <ul className="space-y-4">
                {read.map(n => (
                  <li
                    key={n.id}
